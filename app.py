...
# App title and page selector
st.title('Nylon Dyeing Recipe Status Predictor')
page = st.sidebar.selectbox("Select a Page", ["Nylon Dyeing Recipe Status Predictor", "AI Assistant"])

if page == "Nylon Dyeing Recipe Status Predictor":
    # Your existing code for the Nylon Dyeing Recipe Status Predictor
    ...
    # Content for the AI Assistant page
